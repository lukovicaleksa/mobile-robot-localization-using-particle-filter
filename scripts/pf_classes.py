...
MAPS_PATH = '/home/maestro/catkin_ws/src/pf_localization/Maps/'
...
class Map:
    ...
    def save_objects(self):
        ...
        for (i,w) in enumerate(self.walls):
            np.savetxt(MAPS_PATH + self.name + '/' + w.name + '.csv', np.array([w.x_1, w.x_2, w.y_1, w.y_2]), delimiter = ' , ')
    ...
    def load_objects(self):
        ...
        for object_name in os.listdir(MAPS_PATH + self.name + '/'):
